...
class SelectiveScrutinyRestr(ccobra.CCobraModel):
    def __init__(self, name='SelectiveScrutiny-Restr', method='mReasoner'):
        super(SelectiveScrutinyRestr, self).__init__(name, ['syllogistic-belief'], ['verify'])
